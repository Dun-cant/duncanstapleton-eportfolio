<script lang="ts">
	...
	onMount(() => {
		...
		timeline.fromTo(".name-animation",
			{
				x: -100,
				opacity: 0,
				rotte: -10
...
<section data-slice-type={slice.slice_type} data-slice-variation={slice.variation} class="px-4 md:px-6">
	<div class="mx-auto w-full max-w-7xl">
		<div class="grid min-h-[65vh] grid-cols-1 items-center md:grid-cols-2">
			...
			<span class="job-title block bg-gradient-to-tr from-yellow-500 via-yellow-100 to-yellow-500 bg-clip-text text-transparent text-2xl font-bold uppercase tracking-[.2em] md:text-4xl opacity-0">	
